...
public class ActivityCategoryList extends Activity {
	...
	com.solodroid.ecommerce.AdapterCategoryList cla;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        cla = new com.solodroid.ecommerce.AdapterCategoryList(com.solodroid.ecommerce.ActivityCategoryList.this);

        // category API url
    	CategoryAPI = com.solodroid.ecommerce.Constant.CategoryAPI+"?accesskey="+ com.solodroid.ecommerce.Constant.AccessKey;
		...
		listCategory.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int position,
				...
				// go to menu page
				Intent iMenuList = new Intent(com.solodroid.ecommerce.ActivityCategoryList.this, com.solodroid.ecommerce.ActivityMenuList.class);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.cart:
			// refresh action
			Intent iMyOrder = new Intent(com.solodroid.ecommerce.ActivityCategoryList.this, com.solodroid.ecommerce.ActivityCart.class);
